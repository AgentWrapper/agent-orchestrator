...
<img src="../assets/readme/dashboard.png" alt="Painel do Agent Orchestrator mostrando sessões paralelas de agentes de codificação" width="100%" />
</div>

**Idiomas:** [English](../../README.md) · [简体中文](README.zh-CN.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · [Español](README.es.md) · [Français](README.fr.md) · [Deutsch](README.de.md) · **Português (Brasil)**
...
<table>
  <tr>
    ...
    <td width="64%">
      <img src="../assets/readme/dashboard.png" alt="Quadro do Agent Orchestrator com várias sessões em paralelo" />
    </td>
  </tr>
  <tr>
    <td width="36%">
    ...
    <td width="64%">
      <img src="../assets/readme/session-terminal.png" alt="Terminal de sessão dentro do Agent Orchestrator" />
    </td>
  </tr>
  <tr>
    <td width="36%">
    ...
    <td width="64%">
      <img src="../assets/readme/reviews-tab.png" alt="Aba Reviews mostrando execuções de revisores e ações" />
    </td>
  </tr>
  <tr>
    <td width="36%">
    ...
    <td width="64%">
      <img src="../assets/readme/browser-preview.png" alt="Aba de prévia do navegador mostrando um app local" />
    </td>
  </tr>
</table>
...
| Plataforma            | Download                                                                                                                      |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| macOS (Apple silicon) | [Baixar](https://github.com/Untrivial-ai/agent-orchestrator/releases/latest/download/agent-orchestrator-darwin-arm64.zip)   |
| macOS (Intel)         | [Baixar](https://github.com/Untrivial-ai/agent-orchestrator/releases/latest/download/agent-orchestrator-darwin-x64.zip)     |
| Windows               | [Baixar](https://github.com/Untrivial-ai/agent-orchestrator/releases/latest/download/agent-orchestrator-win32-x64.exe)      |
| Linux (AppImage)      | [Baixar](https://github.com/Untrivial-ai/agent-orchestrator/releases/latest/download/agent-orchestrator-linux-x64.AppImage) |
| Linux (Debian/Ubuntu) | [Baixar](https://github.com/Untrivial-ai/agent-orchestrator/releases/latest/download/agent-orchestrator-linux-x64.deb)      |
| Linux (Fedora/RHEL)   | [Baixar](https://github.com/Untrivial-ai/agent-orchestrator/releases/latest/download/agent-orchestrator-linux-x64.rpm)      |
...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [docs/architecture.md](../architecture.md)                     | Modelo mental do backend, ciclo de vida, persistência, CDC, derivação de status e limites do daemon. |
| [docs/backend-code-structure.md](../backend-code-structure.md) | Propriedade de pacotes e onde cada preocupação de backend deve ficar.                        |
| [docs/cli/README.md](../cli/README.md)                         | Comportamento da CLI e mapeamento de rotas do daemon.                                        |
| [docs/development.md](../development.md)                       | Pré-requisitos, etapas de build, execução de testes e solução de problemas para desenvolvimento local. |
| [docs/STATUS.md](../STATUS.md)                                 | O que atualmente é entregue em `main` e o que ainda está em andamento.                       |
| [docs/stack.md](../stack.md)                                   | Decisões de bibliotecas, runtime e dependências.                                             |
