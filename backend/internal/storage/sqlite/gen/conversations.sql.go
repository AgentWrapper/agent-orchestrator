...
SELECT id, scope, project_id, session_id, latest_sequence, created_at, updated_at, model, reasoning_effort, approval_mode, provider_title, applied_title FROM conversations WHERE id = ? LIMIT 1
`
...
SELECT id, scope, project_id, session_id, latest_sequence, created_at, updated_at, model, reasoning_effort, approval_mode, provider_title, applied_title FROM conversations WHERE session_id = ? LIMIT 1
`
...
SELECT id, conversation_id, handled_by_session_id, provider_turn_id, controller_generation, state, error_message, requested_at, started_at, completed_at, rolled_back_at FROM conversation_turns WHERE id = ? LIMIT 1
`
...
SELECT id, conversation_id, handled_by_session_id, provider_turn_id, controller_generation, state, error_message, requested_at, started_at, completed_at, rolled_back_at FROM conversation_turns
