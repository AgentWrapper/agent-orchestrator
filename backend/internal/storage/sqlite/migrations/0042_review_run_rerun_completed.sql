-- Explicit review triggers should be able to re-run a PR head that already has
-- a completed AO review. Keep the uniqueness guard only for currently-running
-- runs so concurrent triggers cannot create duplicate live work.
