...
-- harness. Migration 0048 shipped with review UNIQUE(session_id) plus a
-- companion review_session table, so this must use a fresh migration version:
-- databases that already recorded 0048 will never execute changed 0048 SQL.
