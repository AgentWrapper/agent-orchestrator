...
BEGIN
	...
	// 0048_add_session_browser_capability_verifier.sql. Some deployed profiles
	// already record later migration versions, so goose can skip this column too.
	{table: "sessions", column: "browser_capability_verifier",
