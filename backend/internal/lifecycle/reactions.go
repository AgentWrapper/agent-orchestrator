...
const (
	...
	// ReviewDeliverySuppressed means the user disabled automatic review-feedback
	// injection, so the caller may stamp the result as intentionally handled
	// without sending it to the worker.
