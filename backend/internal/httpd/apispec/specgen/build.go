...
func reviewOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/reviews/addressed", id: "addressReviewFeedback", tag: "reviews",
			summary:    "Reply to and resolve explicitly addressed review threads",
			pathParams: []any{controllers.SessionIDParam{}},
