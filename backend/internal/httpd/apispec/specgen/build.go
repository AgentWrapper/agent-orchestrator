...
var schemaNames = map[string]string{
	...
	"ControllersAutoInjectReviewFeedbackRequest":          "AutoInjectReviewFeedbackRequest",
	"ControllersAutoInjectReviewFeedbackResponse":         "AutoInjectReviewFeedbackResponse",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPatch, path: "/api/v1/sessions/{sessionId}/auto-inject-review-feedback", id: "setSessionAutoInjectReviewFeedback", tag: "sessions",
			summary:    "Configure automatic review-feedback delivery for a session",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.AutoInjectReviewFeedbackRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.AutoInjectReviewFeedbackResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
