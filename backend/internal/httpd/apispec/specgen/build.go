...
var schemaNames = map[string]string{
	...
	"ControllersAddressedReviewInput":    "AddressedReviewInput",
	"ControllersAddressedReviewResponse": "AddressedReviewResponse",
...
func reviewOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/reviews/addressed", id: "addressedReview", tag: "reviews",
			summary:    "Signal that review feedback was addressed and resolve matching provider review threads",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.AddressedReviewInput{},
			resps: []respUnit{
				{http.StatusOK, controllers.AddressedReviewResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusUnprocessableEntity, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
