...
type SpawnSessionRequest struct {
	...
	Harness   domain.AgentHarness `json:"harness,omitempty" enum:"claude-code,codex,aider,opencode,grok,droid,amp,agy,crush,cursor,qwen,copilot,goose,auggie,continue,devin,cline,kimi,kiro,kilocode,vibe,pi,kimchi,autohand,fake"`
	Branch    string              `json:"branch,omitempty"`
