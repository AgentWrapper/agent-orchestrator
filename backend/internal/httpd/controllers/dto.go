...
// Event/ToolName/ToolUseID are optional tool-flight correlation facts.
// AgentSessionID is optional native metadata discovered from the hook payload
// and persisted for later restore. All are absent on old CLIs.
type SetActivityRequest struct {
	...
	AgentSessionID string `json:"agentSessionId,omitempty" description:"Native agent session identifier discovered from the hook payload."`
}
