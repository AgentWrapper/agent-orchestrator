...
func (c *SessionsController) setMergePolicy(w http.ResponseWriter, r *http.Request) {
	...
	envelope.WriteJSON(w, http.StatusOK, SetSessionMergePolicyResponse{OK: true, SessionID: sessionID(r), TerminateOnPRMerge: in.TerminateOnPRMerge, Session: sessionView(sess)})
}
