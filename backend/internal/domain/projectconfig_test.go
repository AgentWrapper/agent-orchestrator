...
func TestProjectConfigValidate(t *testing.T) {
	tests := []struct {
		...
		{"tracker intake assignee rule", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Assignee: "alice", MaxConcurrent: 2}}, false},
		{"tracker intake explicit github", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Provider: TrackerProviderGitHub, Assignee: "alice", MaxConcurrent: 2}}, false},
		{"tracker intake no assignee", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, MaxConcurrent: 2}}, true},
		{"tracker intake unassigned selector", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Assignee: "none", MaxConcurrent: 2}}, true},
		{"tracker intake unknown provider", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Provider: "linear", Assignee: "alice", MaxConcurrent: 2}}, true},
		{"tracker intake repo with whitespace", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Repo: " acme/demo", Assignee: "alice", MaxConcurrent: 2}}, true},
		{"tracker intake assignee with whitespace", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Assignee: " alice", MaxConcurrent: 2}}, true},
		{"tracker intake legacy label fields do not gate", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Assignee: "alice", MaxConcurrent: 2, Labels: []string{" agent-ok"}, ExcludeLabels: []string{"no-ao"}}}, false},
		...
		{"tracker intake zero max concurrent", ProjectConfig{TrackerIntake: TrackerIntakeConfig{Enabled: true, Assignee: "alice"}}, true},
