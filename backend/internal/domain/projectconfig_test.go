...
func TestProjectConfigValidate(t *testing.T) {
	tests := []struct {
		...
		{"good mcp none", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeNone}}}, false},
		{"good mcp inherit", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeInherit}}}, false},
		{"good mcp custom file", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeCustom, ConfigFile: ".ao/worker-mcp.json"}}}, false},
		{"good mcp custom servers", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeCustom, Servers: map[string]MCPServerConfig{"code-graph": {"command": "code-graph-mcp"}}}}}, false},
		{"bad permission", ProjectConfig{AgentConfig: AgentConfig{Permissions: "yolo"}}, true},
		{"bad mcp mode", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: "all"}}}, true},
		{"bad mcp none with servers", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeNone, Servers: map[string]MCPServerConfig{"browser": {"command": "browser-mcp"}}}}}, true},
		{"bad mcp custom missing source", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeCustom}}}, true},
		{"bad mcp config file absolute", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeCustom, ConfigFile: "/tmp/mcp.json"}}}, true},
		{"bad mcp blank server name", ProjectConfig{AgentConfig: AgentConfig{MCP: MCPConfig{Mode: MCPModeCustom, Servers: map[string]MCPServerConfig{" ": {"command": "x"}}}}}, true},
