...
// needs (git diff/log/show to inspect the change and printf to pipe review JSON
// into `ao review publish` without writing a worktree file) without stalling.
