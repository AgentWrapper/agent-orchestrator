...
// Trigger starts a review pass for a worker. An empty override keeps the
// project's configured reviewer; a known one runs this pass under it without
// editing project config, which the harness-change path below already handles by
// respawning the reviewer pane.
