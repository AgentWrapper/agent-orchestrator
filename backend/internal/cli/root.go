...
func shouldEmitCLIInvocation(cmd *cobra.Command) bool {
	...
	// "ao completion"/"ao help" are shell setup and self-documentation, and
	// "ao pty-host" is an internal Windows runtime host. None reflect user
	// activity. "ao hooks" is agent activity and is still reported, but the
	// daemon keeps it out of ao.app.active/DAU.
