...
export const shortcutLabelKeys: Record<AppShortcutId, MessageKey> = {
	...
	"browser-new-tab": "shortcut.browser-new-tab",
	"browser-reopen-tab": "shortcut.browser-reopen-tab",
	"browser-reload": "shortcut.browser-reload",
	"browser-close-tab": "shortcut.browser-close-tab",
};
...
export const shortcutCategoryLabelKeys: Record<ShortcutCategory, MessageKey> = {
	...
	Browser: "shortcut.category.browser",
};
