...
const REVIEWER_HARNESS_IDS = ["claude-code", "codex", "opencode", "greptile"] as const satisfies readonly ReviewerHarnessId[];
...
const REVIEWER_AGENT_PRIORITY = ["claude-code", "codex", "cursor", "opencode", "greptile", "aider"] as const;
