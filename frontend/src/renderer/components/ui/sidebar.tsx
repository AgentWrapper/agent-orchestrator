...
function SidebarMenuBadge({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"pointer-events-none absolute right-1 flex h-control-xs min-w-control-xs items-center justify-center rounded-md px-1 text-xs font-medium leading-none text-sidebar-foreground tabular-nums select-none",
