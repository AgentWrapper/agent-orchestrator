	...
	"inline-flex items-center transition-[filter,background,color,border-color] duration-fast disabled:opacity-60",
	{
		variants: {
			variant: {
				...
				kill: "h-control-lg gap-1.5 rounded-md border border-transparent bg-transparent px-2.5 text-sm font-semibold leading-none text-error/80 hover:border-error/50 hover:bg-error/10 hover:text-error",
				killConfirm:
