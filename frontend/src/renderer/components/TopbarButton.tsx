	...
	"inline-flex items-center transition-[filter,background,color,border-color] duration-fast disabled:opacity-60",
	{
		variants: {
			variant: {
				...
				kill: "h-control-lg gap-1.5 rounded-md border border-border bg-raised px-3.5 text-sm font-semibold leading-none text-muted-foreground hover:bg-surface hover:text-foreground",
				killConfirm:
