	...
	return (
		<SidebarMenuItem className="mb-px group-data-[collapsible=icon]:mb-0">
			...
			>
				...
				{pauseBadge && (
					<span
						className="sidebar-expanded-chrome hidden h-4 shrink-0 place-items-center rounded bg-warning/15 px-1 text-[10px] leading-none font-medium text-warning group-data-[collapsible=icon]:hidden md:inline-flex md:items-center"
						title={pauseBadge}
					>
						{pauseBadge}
					</span>
