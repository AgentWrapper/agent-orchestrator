...
export function buildTerminalThemes(): { dark: ITheme; light: ITheme } {
	...
	const light: ITheme = {
		...
		black: cssVar("--color-term-light-black"),
		red: cssVar("--color-term-light-red"),
		green: cssVar("--color-term-light-green"),
		yellow: cssVar("--color-term-light-yellow"),
		blue: cssVar("--color-term-light-blue"),
		magenta: cssVar("--color-term-light-magenta"),
		cyan: cssVar("--color-term-light-cyan"),
		white: cssVar("--color-term-light-white"),
		brightBlack: cssVar("--color-term-light-bright-black"),
		brightRed: cssVar("--color-term-light-bright-red"),
		brightGreen: cssVar("--color-term-light-bright-green"),
		brightYellow: cssVar("--color-term-light-bright-yellow"),
		brightBlue: cssVar("--color-term-light-bright-blue"),
		brightMagenta: cssVar("--color-term-light-bright-magenta"),
		brightCyan: cssVar("--color-term-light-bright-cyan"),
		brightWhite: cssVar("--color-term-light-bright-white"),
	};
