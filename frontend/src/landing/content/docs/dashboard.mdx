...
Merged sessions remain visible in the **Ready to merge / Merged** lane. Terminated sessions appear in the collapsed **Terminated** area, where you can restore one when you need to inspect or continue it.
