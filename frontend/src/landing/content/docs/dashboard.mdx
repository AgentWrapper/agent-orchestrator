...
Live merged sessions remain visible in the **Ready to merge / Merged** lane. Terminated runtimes, including terminated sessions whose PR is merged, appear in the collapsed **Archive** area as compact rows and can be restored when you need to inspect or continue them.
