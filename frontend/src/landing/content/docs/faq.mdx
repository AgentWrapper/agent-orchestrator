...
<Accordion title="Do I have to use Claude Code?">
	No. AO supports Claude Code, Codex, Codex Fugu, Cursor, Aider, and OpenCode today. Set `agent:` per project (or per
	spawn with `--agent`). See [Agents](/docs/plugins/agents).
</Accordion>
