...
<Tabs items={["npm", "pnpm", "yarn", "from source"]}>
	<Tab value="npm">
		<code>npm install -g @aoagents/ao</code>
	</Tab>
	<Tab value="pnpm">
		<code>pnpm add -g @aoagents/ao</code>
	</Tab>
	<Tab value="yarn">
		<code>yarn global add @aoagents/ao</code>
	</Tab>
	<Tab value="from source">
		<pre>
			<code>{`git clone https://github.com/ComposioHQ/agent-orchestrator
cd agent-orchestrator
pnpm install
pnpm build
pnpm --filter @aoagents/ao link --global`}</code>
		</pre>
	</Tab>
</Tabs>
...
codex`}</code>
	...
	<Tab value="Cursor">
		<pre>
			<code>{`curl https://cursor.com/install -fsS | bash
agent --help`}</code>
		</pre>
	</Tab>
	<Tab value="Aider">
		<pre>
			<code>{`pip install aider-install
aider-install
aider --help`}</code>
		</pre>
	</Tab>
