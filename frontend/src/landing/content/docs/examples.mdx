...
- `projectPrefix` keeps session IDs readable (`fe-123`, `api-456`) when multiple projects run simultaneously. Existing `sessionPrefix` entries are accepted as a compatibility alias.
