...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description:
      "24 harnesses supported, with per-project agent choice. Claude Code, Codex, Cursor, OpenCode, Aider, Goose, and more, AO keeps it running the way you already run it while the tools underneath evolve.",
