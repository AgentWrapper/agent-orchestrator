...
// through the real daemon/filesystem. Real-boundary coverage is the packaged-app
// pod gate (#2697). Case IDs cross-reference the #2483 catalog; not a claim of
// full-boundary coverage, and this suite is not the canonical T0/P0 gate.
