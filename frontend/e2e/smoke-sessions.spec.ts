...
// daemon, storage, API, preload, PTY, or filesystem. Real end-to-end coverage
// for these cases is the packaged-app pod gate (#2697). The case IDs
// cross-reference the #2483 catalog; they are not a claim of full-boundary
